...
| `model_selection.md` | Why the second model is granite-3.1-2b: `tpu-inference`'s tested list is attention-homogeneous (all head_dim=128 GQA), so replicating inside it would prove nothing. |
